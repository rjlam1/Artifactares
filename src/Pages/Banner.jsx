...
const Banner = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1575408264798-b50b252663e6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1653&q=80",
      ...
      <div className="flex justify-center gap-3 absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20">
        {slides.map((_, index) => (
          <motion.button
            ...
            className={`w-3 h-3 rounded-full ${index === currentSlide ? 'bg-white' : 'bg-gray-300 bg-opacity-50'}`}
