...
//   if (loading) {
//     return (
//       <section className="my-24 px-4 max-w-8xl mx-auto bg-gradient-to-b from-gray-900 to-gray-800">
...
const FeaturedArtifacts = () => {
  ...
  if (loading) {
    return (
      <section className=" max-w-9xl mx-auto bg-gradient-to-b from-gray-900 to-gray-800">
        <motion.h2
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
  ...
  if (error) {
    return (
      <section className=" max-w-9xl mx-auto text-center bg-gradient-to-b from-gray-900 to-gray-800 rounded-3xl ">
        <motion.h2
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="text-5xl font-bold mb-10"
  ...
  return (
    <section className=" max-w-9xl mx-auto bg-gradient-to-b from-gray-900 to-gray-800  py-12">
      <motion.h2
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
      ...
      {artifacts.length === 0 ? (
        ...
        >
          ...
          <h3 className="mt-4 text-2xl font-medium text-amber-900">
            Gallery Currently Empty
          </h3>
          <p className="mt-2 text-amber-700 max-w-md mx-auto">
            Our curators are preparing exceptional pieces for your appreciation
          </p>
          <button className="mt-6 inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-full shadow-sm text-white bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 transition-all duration-200 transform hover:scale-105">
            Notify Me When Available
          </button>
              ...
              >
                <div className="relative h-72 overflow-hidden">
                  <img
                    ...
                    onError={(e) => {
                      e.target.className =
                        "w-full h-full object-cover bg-gradient-to-br from-amber-100 to-amber-200";
                      e.target.parentElement.innerHTML = `
                        <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-amber-100 to-amber-200">
                          <svg class="h-16 w-16 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                ...
                <div className="p-7">
                  <h3 className="text-2xl font-bold text-gray-900 mb-3 font-serif tracking-tight">
                    {artifact.name}
                  </h3>
                  <p className="text-gray-600 mb-5 line-clamp-2 font-light">
                    {artifact.shortDescription ||
                      "A remarkable piece awaiting your discovery"}
                  </p>
                  <div className="flex justify-between items-center">
                    <div className="flex items-center">
                      <svg
