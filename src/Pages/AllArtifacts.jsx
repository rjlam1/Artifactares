  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-stone-50 to-stone-100">
         <Helmet>
          <title>ArtifactEra | AllArtifact</title>
        </Helmet>
    ...
    <section className="py-12 px-4 md:px-8  min-h-screen bg-gradient-to-r from-gray-800 to-gray-900">
      ...
      <div className="max-w-8xl mx-auto relative">
        ...
        <motion.div 
          ...
          className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 mb-10 border border-stone-200/50"
        >
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xs font-medium text-stone-500 bg-stone-100/50 px-2.5 py-1 rounded-full">
