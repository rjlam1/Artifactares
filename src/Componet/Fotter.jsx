  ...
  return (
    <footer className="bg-gradient-to-b from-[#0a1f38] to-[#0e2745] text-[#d2b44c] pt-16 pb-8">
      <div className="container mx-auto px-6">
            ...
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                ...
                >
                  <Link 
                    to={link.path} 
                    className="flex items-center text-[#d2b44c]/90 hover:text-white transition-colors duration-300 group"
                  >
            ...
            <ul className="space-y-4">
              {contactInfo.map((info, index) => (
                <li key={index} className="flex items-start">
                  <span className="mt-1 mr-3 text-[#d2b44c]">
                    {info.icon}
                  </span>
                  <span className="text-[#d2b44c]/90 hover:text-white transition-colors duration-300">
                    {info.text}
                  </span>
                </li>
              ))}
        ...
        {/* Bottom Bar */}
        <motion.div 
          className="border-t border-[#1d3d5c] pt-8 flex flex-col md:flex-row justify-between items-center"
          initial={{ opacity: 0 }}
